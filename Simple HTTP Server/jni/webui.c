		...
		const struct mg_request_info *ri, void *data)
{
		...
		mg_printf(conn, "HTTP/1.1 200 OK\r\n"
		    "content-Type: text/html\r\n\r\n"
		    "Welcome to Simple HTTP Server<br>"
		    "<a href=\"share.apk\">Download Http Server apk</a><br><br>"
		    "<a href=\"upload.htm\">Upload File</a><br><br>"
		    "<a href=\"mailto:rvd.kashyap@gmail.com\">email:rvd.kashyap (at) gmail.com</a><br>"
		    "<a href=\"http://amreeta.co.in\">Amreeta Developers </a><br>"
